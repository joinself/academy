...
> **🎯 What you'll learn:** How to get verified credentials from an email address

This example demonstrates **Create Credentials** with Self SDK by using an email address.
...
### Step 4: Verify Email
```
An email flow is initiated by the SDK, guiding users to enter their email addresses. 
